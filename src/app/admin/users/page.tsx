    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <p className="mt-1 text-sm text-nicta-neutral-700">
          ...
          account exists here (docs/assumptions-and-decisions.md#A3). Real accounts must therefore
          be added with the person&rsquo;s actual Entra ID / Microsoft 365 email address: that
          address is what matches them at sign-in once <code>AUTH_PROVIDER=entra</code> is
          configured (see <code>docs/entra-id-registration-guide.md</code>). An address that
          doesn&rsquo;t match their Microsoft account will be rejected as not provisioned.
        </p>
